...
Build a FastAPI gateway that:
1. receives external webhook events
2. verifies signatures
3. applies idempotent ingest persistence
4. forwards accepted events to internal agent forward endpoint
5. retries failed forward attempts safely
